    ...
    function addTriggerQuestionCC() {
        if (window.parent.$('iframe[id=' + activeTier1IframeId + ']').contents().find("label:contains('Review & Submit Payment Confirmation')").length > 0 &&
            ...
            if (document.getElementById("pyWorkPageSaveCreditCardInfoNo").checked) {
                $('#pyWorkPageSaveCreditCardInfoNo').parent().addClass('weeewew').prev().addClass('s').parent().parent().addClass('1').parent().parent().parent().addClass('11').prev().parent().append('<div style="" id="cctrigger" class="content-item content-field item-1" string_type="field" reserve_space="false"><div class="content-inner "><div class="field-item dataValueRead">Does the caller want a link to the Guest Payment Portal?</div></div></div>   <div style="" class="content-item content-field item-2   " string_type="field" reserve_space="false"><div class="content-inner "><div class="field-item dataValueWrite"><div class="radioTable" role="radiogroup" aria-label=" Required" radvalue="" data-ctl="RadioGroup"><div><span class="col-3"><input onclick="window.parent.openGPPCc()" validationtype="required" id="cccbtnyes" type="radio" name="$PpyWorkPage$pSaveCreditCardInfo" value="Yes" class="Radio" style="vertical-align: middle;"><label title="" for="cccbtnyes" class="rb_ rb_standard radioLabel">Yes</label></span><span class="col-3"><input validationtype="required" id="cccbtnno" type="radio" name="cccbtnno" value="No" class="Radio" style="vertical-align: middle;"><label title="  for="cccbtnno" class="rb_ rb_standard radioLabel">No</label></span></div><div class="iconErrorDiv dynamic-icon-error-div" id="$PpyWorkPage$pSaveCreditCardInfoError"><span class="iconError dynamic-icon-error" title="Value cannot be blank" errid="" role="alert" aria-live="assertive" aria-relevant="text" aria-atomic="true">Value cannot be blank</span></div></div></div></div></div>');
                if (sessionStorage.getItem("messageSuccessCc") !== null) {
