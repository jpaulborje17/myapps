      ...
      function addTriggerQuestionCC() {
        ...
        window.parent.$('iframe[id=' + activeTier1IframeId + ']').contents().find("#cctrigger").length === 0) {
            if(document.getElementById("pyWorkPageSaveCreditCardInfoNo").checked) {
                $('#RULE_KEY > div:nth-child(3) > div > div').append('<div style="" class="content-item content-field item-1" string_type="field" reserve_space="false"><div class="content-inner "><div class="field-item dataValueRead">Does the caller want a link to the Guest Payment Portal?</div></div></div><div style="" class="content-item content-field item-2   " string_type="field" reserve_space="false"><div class="content-inner "><div class="field-item dataValueWrite"><div class="radioTable" role="radiogroup" aria-label=" Required" radvalue="No" data-ctl="RadioGroup" data-click="[[&quot;refresh&quot;, [&quot;thisSection&quot;,&quot;&quot;, &quot;&quot;, &quot;&amp;=&quot;, &quot;&quot;, &quot;,&quot;,&quot;:event&quot;,&quot;&quot;,&quot;pyWorkPage&quot;]]]"><div><span class="col-3"><input validationtype="required" id="pyWorkPageSaveCreditCardInfoYes" type="radio" data-click="..." name="$PpyWorkPage$pSaveCreditCardInfo" value="Yes" class="Radio" style="vertical-align: middle;"><label title="" data-click="..." for="pyWorkPageSaveCreditCardInfoYes" class="rb_ rb_standard radioLabel">Yes</label></span><span class="col-3"><input validationtype="required" id="pyWorkPageSaveCreditCardInfoNo" type="radio" data-click="..." name="$PpyWorkPage$pSaveCreditCardInfo" value="No" class="Radio" checked="" style="vertical-align: middle;"><label title="" data-click="..." for="pyWorkPageSaveCreditCardInfoNo" class="rb_ rb_standard radioLabel">No</label></span></div></div></div></div></div>');
            }
        }
