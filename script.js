      ...
      function addTriggerQuestionCC() {
        ...
        window.parent.$('iframe[id=' + activeTier1IframeId + ']').contents().find("#cctrigger").length === 0) {
            if(document.getElementById("pyWorkPageSaveCreditCardInfoNo").checked) {
                $('#RULE_KEY > div:nth-child(3) > div > div').append('<div bsimplelayout="true" id="cctrigger" class="content layout-content-inline content-inline  "><div style="" class="content-item content-field item-2   " string_type="field" reserve_space="false"><div class="content-inner "><div class="field-item dataValueRead">Does the caller want a link to the Guest Payment Portal?</div></div></div><div class="content-item content-field item-2" string_type="field" reserve_space="false"><div class="content-inner "><div class="field-item dataValueWrite"><div class="radioTable" role="radiogroup" radvalue="No"></div><div><span class="col-3"><input id="cccyesbtn" type="radio" name="$cccyesbtn" value="Yes" class="Radio" style="vertical-align: middle;"><label title=""for="cccyesbtn" class="rb_ rb_standard radioLabel">Yes</label></span><span class="col-3"><input id="cccyesbtnno" type="radio" data-click="..." name="cccyesbtnno" value="No" class="Radio" checked="" style="vertical-align: middle;"><label title="" data-click="..." for="cccyesbtnno" class="rb_ rb_standard radioLabel">No</label></span></div></div></div></div></div></div>');
            }
        }
